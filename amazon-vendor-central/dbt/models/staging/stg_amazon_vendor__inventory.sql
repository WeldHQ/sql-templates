...
--
-- Same overlap warning as stg_amazon_vendor__sales: distributor_view and
...
FROM (
    ...
    FROM {{ source('amazon_vendor_central', 'vendor_inventory_report') }}
)
