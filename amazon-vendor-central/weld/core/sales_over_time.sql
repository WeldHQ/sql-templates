-- amazon_vendor_sales_over_time - the vendor sales report, one row per day, with the
...
-- Depends on: staging.amazon_vendor.sales
--
...
FROM {{staging.amazon_vendor.sales}} s
