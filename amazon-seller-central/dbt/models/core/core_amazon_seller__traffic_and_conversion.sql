-- core_amazon_seller__traffic_and_conversion - sessions, page views, Buy Box share and
...
-- Depends on: stg_amazon_seller__sales_and_traffic_by_asin, .listings
--
...
WITH by_asin AS (
    ...
    FROM {{ ref('stg_amazon_seller__sales_and_traffic_by_asin') }} t
    GROUP BY 1, 2, 3, 4, 5
)
