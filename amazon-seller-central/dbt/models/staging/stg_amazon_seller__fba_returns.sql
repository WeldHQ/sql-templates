-- stg_amazon_seller__fba_returns
...
--
-- The FBA equivalent of stg_amazon_seller__returns, and deliberately a separate
...
FROM {{ source('amazon_seller_central', 'fba_returns_report') }}
