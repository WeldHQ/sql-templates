-- stg_amazon_seller__sales_and_traffic_by_asin
...
-- sessions across SKUs therefore over-counts. core_amazon_seller__traffic_and_conversion
...
FROM (
    ...
    FROM {{ source('amazon_seller_central', 'sales_and_traffic_report_by_asin_sku') }}
)
