...
-- staging.amazon_seller.fba_returns. Union them and you double-count any account
...
SELECT
    ...
    -- Negative, matching the discount convention in staging.amazon_seller.orders,
...
FROM {{raw.amazon_seller_central.returns_by_return_date_report}}
