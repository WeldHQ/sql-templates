-- amazon_seller_sales_over_time - recreates Amazon's Business Reports "Sales and
...
-- Depends on: staging.amazon_seller.sales_and_traffic_by_date
--
...
-- core.amazon_seller.product_sales_over_time when you need it split by ASIN.
--
...
--                           every fee. Lives in core.amazon_seller.settlement_ledger
...
SELECT
    ...
    -- For that, use core.amazon_seller.product_sales_over_time, which keeps the
...
FROM {{staging.amazon_seller.sales_and_traffic_by_date}} d
