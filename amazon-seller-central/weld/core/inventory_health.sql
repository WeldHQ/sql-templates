-- amazon_seller_inventory_health - what is in Amazon's warehouses, how long it lasts,
-- and how much of it is dead.
--
-- Grain: seller x marketplace x SKU. Point in time - see the note below.
-- Depends on: staging.amazon_seller.fba_inventory, .listings,
--             core.amazon_seller.product_sales_over_time
--
...
FROM {{staging.amazon_seller.fba_inventory}} i
